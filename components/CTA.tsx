...
export default function CTA({ onCartOpen }: Props) {
  return (
    <section style={{
      textAlign: "center",
      padding: "48px 20px calc(80px + env(safe-area-inset-bottom))",
      background: "var(--text)",
      color: "#fff",
      ...
      <p style={{ fontSize: 15, color: "rgba(255,255,255,.5)", maxWidth: 380, margin: "0 auto 28px", lineHeight: 1.6 }}>
        Revísalo y envíalo por WhatsApp. Te confirmamos en menos de una hora.
      </p>
      <button
        onClick={onCartOpen}
        style={{
