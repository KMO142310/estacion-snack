...
const WA_LINK = "https://wa.me/56953743338?text=Hola!%20Quiero%20pedir%20%F0%9F%8C%B0";
  ...
  return (
    <footer style={{ background: "var(--text)", color: "rgba(255,255,255,.65)", padding: "48px 0 24px", marginTop: 24 }}>
      <div className="wrap">
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <a
                href="https://instagram.com/estacionsnack"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Estación Snack en Instagram"
                style={{ color: "rgba(255,255,255,.65)", transition: "color .2s" }}
              ...
              <a
                href="https://tiktok.com/@estacionsnack"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Estación Snack en TikTok"
                style={{ color: "rgba(255,255,255,.65)", transition: "color .2s" }}
                className="social-link"
              >
                <svg width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.67a8.24 8.24 0 004.83 1.54V6.74a4.85 4.85 0 01-1.06-.05z"/>
                </svg>
              </a>
              <a
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8, fontSize: 13 }}>
              ...
              <li><Link href="/envios" style={{ color: "rgba(255,255,255,.65)" }}>Envíos</Link></li>
              <li><Link href="/faq" style={{ color: "rgba(255,255,255,.65)" }}>Preguntas frecuentes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8, fontSize: 13 }}>
              ...
              <li>
                <a href={WA_LINK} target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.65)" }}>
                  WhatsApp directo
                </a>
              </li>
            </ul>
        ...
        <div style={{ paddingTop: 24, display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 8, fontSize: 11 }}>
          <span>© 2026 Estación Snack · Santa Cruz, Chile</span>
          <span>Hecho con cariño en O'Higgins</span>
        </div>
      </div>
