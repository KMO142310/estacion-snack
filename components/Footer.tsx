...
export default function Footer() {
  return (
    <footer style={{ background: "#5A1F1A", color: "rgba(244,234,219,0.65)", padding: "3rem 0 1.5rem" }}>
      <div className="wrap">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "2rem", paddingBottom: "2rem", borderBottom: "1px solid rgba(244,234,219,0.10)" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              <a href="https://instagram.com/estacionsnack.sc" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: "rgba(244,234,219,0.55)", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#F4EADB"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(244,234,219,0.55)"; }}>
              ...
              <a href="https://wa.me/56953743338" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ color: "rgba(244,234,219,0.55)", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#F4EADB"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(244,234,219,0.55)"; }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              {[["/#productos", "Mezclas"], ["/#packs", "Packs"], ["/envios", "Envíos"], ["/faq", "FAQ"]].map(([href, label]) => (
                <li key={label}>
                  <a href={href} style={{ fontFamily: "var(--font-body)", fontSize: "0.8125rem", color: "rgba(244,234,219,0.65)", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#F4EADB"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(244,234,219,0.65)"; }}>
                    {label}
                  </a>
                </li>
              ))}
