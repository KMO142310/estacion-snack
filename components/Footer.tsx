  ...
  return (
    <footer style={{ background: "#5A1F1A", color: "rgba(244,234,219,0.85)", padding: "4rem 1.25rem 2rem" }}>
      <div className="wrap" style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        {/* Redes — dos iconos centrados, simples */}
        <div style={{ display: "flex", gap: "1.25rem", justifyContent: "center", marginBottom: "2.5rem" }}>
          <a
            href="https://instagram.com/estacionsnack.sc"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram @estacionsnack.sc (se abre en nueva pestaña)"
            style={{ color: "rgba(244,234,219,0.75)", display: "inline-flex" }}
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp +56 9 5374 3338 (se abre en nueva pestaña)"
            style={{ color: "rgba(244,234,219,0.75)", display: "inline-flex" }}
          >
            <svg width={22} height={22} viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Links secundarios — discretos, dos filas */}
        <nav
        ...
        >
          ...
          <Link href="/cambios-devoluciones" style={{ color: "inherit" }}>Devoluciones</Link>
        </nav>
        ...
        <div
          style={{
            paddingTop: "1.5rem",
            borderTop: "1px solid rgba(244,234,219,0.12)",
            fontFamily: "var(--font-body)",
            fontSize: "0.75rem",
        ...
        >
          © 2026 Estación Snack · Hecho con cariño en O&apos;Higgins
        </div>
      </div>
    </footer>
  );
