  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "10px 10px 12px" }}>
        <p style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 14, color: "#5A1F1A", lineHeight: 1.2, marginBottom: 4 }}>
          {name}
        </p>
        <p className="price" style={{ fontFamily: "var(--font-body)", fontWeight: 700, fontSize: 14, color: agotado ? "#aaa" : "#D0551F", marginBottom: 10 }}>
        ...
        {!agotado && (
          <button
            onClick={handleAdd}
            style={{
              width: "100%", fontFamily: "var(--font-body)", fontWeight: 600, fontSize: 12,
